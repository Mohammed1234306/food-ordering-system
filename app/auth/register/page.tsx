...
// After registration, Supabase automatically creates a profile
    ...
    <div className="min-h-screen bg-warm-gradient flex items-center justify-center px-4 py-12">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="relative w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-muted-foreground text-sm mt-1">Join us for delicious food!</p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-card-hover border border-border p-8">
          ...
          <button onClick={handleGoogleLogin} disabled={isGoogleLoading || isLoading}
            className="w-full flex items-center justify-center gap-3 py-3 border border-border rounded-xl hover:bg-secondary transition-colors font-medium text-sm disabled:opacity-60 mb-6">
          ...
          <div className="flex items-center gap-4 mb-6">
            <div className="flex-1 h-px bg-border" /><span className="text-xs text-muted-foreground font-medium">OR</span><div className="flex-1 h-px bg-border" />
          </div>

          <form onSubmit={handleRegister} className="space-y-4">
            {errors.general && (
              <div className="p-3 bg-red-50 border border-red-200 rounded-xl text-red-700 text-sm">{errors.general}</div>
            )}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" value={fullName} onChange={e => setFullName(e.target.value)}
                  placeholder="John Doe" className={`input-base pl-10 ${errors.fullName ? 'border-red-400' : ''}`} />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" value={email} onChange={e => setEmail(e.target.value)}
                  placeholder="you@example.com" className={`input-base pl-10 ${errors.email ? 'border-red-400' : ''}`} />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type={showPassword ? 'text' : 'password'} value={password} onChange={e => setPassword(e.target.value)}
                  placeholder="At least 6 characters" className={`input-base pl-10 pr-10 ${errors.password ? 'border-red-400' : ''}`} />
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type={showPassword ? 'text' : 'password'} value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)}
                  placeholder="Repeat your password" className={`input-base pl-10 ${errors.confirmPassword ? 'border-red-400' : ''}`} />
              </div>
